...
function EditDealerPart(props) {
  ...
  const [bike, setBike] = useState({
    ...
    useEffect(() => {
        ...
        axios
            .get(`http://localhost:8080/users/dealer/editPart/${partId}`)
    ...
    const handleSubmit = (event) => {
        ...
        axios
            .put(`http://localhost:8080/users/dealer/updatePart/${partId}`, bike)
